...
public class PointType extends Struct {
    ...
    public oracle.jbo.domain.Number getXCoord() {
        return (oracle.jbo.domain.Number) getAttribute(0);
    }
    ...
    public oracle.jbo.domain.Number getYCoord() {
    ...
    public void setlkj(String value) {
    ...
    public void initStructureDef() {
        ...
        if (mStructureDef == null) {
            attrs[0] = new DomainAttributeDef("XCoord", "X_COORD", 0, Number.class, 2, "NUMERIC", -127, 0, false);
            attrs[1] = new DomainAttributeDef("YCoord", "Y_COORD", 1, Number.class, 2, "NUMERIC", -127, 0, false);
