    ...
    public static ORADataFactory getORADataFactory() {
        if (fac == null) {
            class facClass implements DatumFactory {
                public Datum createDatum(CallableStatement jdbc, int index) throws SQLException {
                    byte[] data = jdbc.getBytes(index);
                    return (data != null) ? new EvenNumber(data) : null;
                }

                public Datum createDatum(ResultSet jdbc, int index) throws SQLException {
                    byte[] data = jdbc.getBytes(index);
                    return (data != null) ? new EvenNumber(data) : null;
                }
