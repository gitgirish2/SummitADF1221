 ...
 *         &lt;element name="empView1" type="{/oracle/summit/model/sdo/views/common/}EmpViewSDO" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "", propOrder = { "changeOperation", "empView1", "processControl" })
@XmlRootElement(name = "processEmpView1")
public class ProcessEmpView1 {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<EmpViewSDO> empView1;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the empView1 property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEmpView1().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     *
     */
    public List<EmpViewSDO> getEmpView1() {
        if (empView1 == null) {
            empView1 = new ArrayList<EmpViewSDO>();
        }
        return this.empView1;
    }
