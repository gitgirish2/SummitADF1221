...
@XmlSeeAlso({
            BigDecimalResult.class, DataObjectResult.class, BooleanResult.class, TimeResult.class, DateResult.class,
            BytesResult.class, DoubleResult.class, ShortResult.class, BigIntegerResult.class, DataHandlerResult.class,
            IntegerResult.class, FloatResult.class, StringResult.class, ByteResult.class, LongResult.class,
