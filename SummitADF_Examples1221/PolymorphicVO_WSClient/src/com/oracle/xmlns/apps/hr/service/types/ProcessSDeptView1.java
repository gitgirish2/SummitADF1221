 ...
 *         &lt;element name="sDeptView1" type="{/oracle/summit/model/polymorphicvo/views/common/}SDeptViewSDO" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "", propOrder = { "changeOperation", "sDeptView1", "processControl" })
@XmlRootElement(name = "processSDeptView1")
public class ProcessSDeptView1 {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<SDeptViewSDO> sDeptView1;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the sDeptView1 property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSDeptView1().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     *
     */
    public List<SDeptViewSDO> getSDeptView1() {
        if (sDeptView1 == null) {
            sDeptView1 = new ArrayList<SDeptViewSDO>();
        }
        return this.sDeptView1;
    }
